...
public class SurvivalStats : MonoBehaviour
{
    ...
    public void DamageOnHarvesting()
    {
        ...
        currentSuitDurability = Mathf.Max(0, currentSuitDurability - harvestingDamage);          // 0값 이하로 안 내려가게 막기 위해서
        CheckDeath();
    }
    ...
    private void PlayerDeath()                              // 플레이어 사망 처리 체크 함수
    {
        isGameOver = true;
        Debug.Log("플레이어 사망!");
    ...
    public void ResetStats()        // 리섹 함수 작성 (변수들 초기화 용도)
    {
        isGameOver = false;
        isPaused = false;
        currentHunger = maxHunger;
